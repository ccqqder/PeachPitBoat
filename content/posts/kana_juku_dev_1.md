...
此時因為 Spec-Driven Development (SDD) 很紅，gemini也推出對標claude code的gemni cli，所以**嘗試**了一下，

發現省去複製貼上的步驟效率大幅提升，以及修改後貼回去找要修改哪幾行的步驟也不用了。

這是我已經確信寫程式應該使用agent 而不是chatbot，所以又跑去訂閱claude 使用claude code(以下簡稱CC)。
...
一開始就覺得CC對相關檔案的尋找跟閱讀挺聰明的，畢竟不像在網頁上直接貼的完全是自己想要的部分，對於專案許多目錄檔案的環境很重要。

因為我的mac mini是最便宜的等級空間很小，有一次硬碟爆滿無法使用，我直接問CC怎麼辦？就像我在聊天機器人的網頁那樣問。

CC直接給出具體的方案，列出可以清除哪些目錄、可以把哪些目錄搬移到外接硬碟等等…並問我這樣處理是否OK？

我擔心他把電腦搞壞，所以一步步允許他操作，最後全部都順利完成了。

我對麥金塔還有xcode編譯環境不熟，這時我發現AI對所有事情包括我不熟悉的都有八十分以上的理解，並且會寫程式大約等於會操控電腦。

使用agent 的開發速度已經不可同日而語，我完全小看AI進步的速度，並且讓我這大約三個月的落後顯得無比愚蠢。
...
至少，在AI發展塵埃落定(一兩年停滯或者直接達到AGI通用人工智能)前是這樣。

**\[2025年11月24日]**

opus4.5釋出。opus是claude 收費最高的旗艦模型，此時4.5釋出，相比前一代它除了各方面性能顯著提升，

差別最大的是他對於意圖的理解，舊版只是指哪打哪(實際上也已經很不錯了)，

從4.5版開始，他收到你的需求後，會先做一定程度的總結跟規劃，用人格套用的話就是，更機靈更有經驗了。

不用再很具體的說哪個檔案要怎麼修改，只需要像主管或老闆描述最終需求，他就會展開並規劃下一兩個步驟的事。

這種規劃的能力對效率的提升又更大了，前面說過AI對所有事情都知道八成以上，

搭配這點大幅增加抽象的程度，更多東西外包給了CC，逐漸的開始不用自己查看跟修改程式碼了。

至此，社群媒體對於AI寫程式的爭論到此結束，

至少，他讓我原本自己花一兩年做得到的事情，變成兩三個月內完成，甚至成品是我的能力再往外擴散一些。

我本身只是用龐克搖滾的方式再做專案，只求功能堪用以及達到價值訴求，尚且如此，

對於全職軟體工程師跟高手們更是驚喜交雜、摧枯拉朽。

靠著魔法般的生產力，

在白天要上班，在好幾個專案輪流切換的情況下，
